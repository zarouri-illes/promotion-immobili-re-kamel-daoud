      ...
      <div className="flex flex-col lg:flex-row justify-between lg:justify-center lg:gap-24  items-center gap-2 ">
        <div>
          <motion.img
            ...
            src={profile.image.link}
            alt={profile.image.alt}
            className="w-[500px] md:w-[450px] lg:w-[400px]"
          />
        </div>
        ...
        >
          <h1 className="xl:text-6xl font-bold text-secondary lg:text-4xl">
            {profile.name}
          </h1>
          <p className="xl:text-xl text-lg text-gray md:max-w-[600px] lg:text-[15px]">
            {profile.description}
          </p>
        </motion.div>
      </div>
