            ...
            <div>
              <div className="relative">
                <img
                  ...
                  src={item.image.link}
                  alt={item.image.alt}
                  className="rounded-t-[10px] h-[300px]"
                />

                {item.situation === 0 ? (
                  <Situ text="Vendu" color="bg-primary" />
                ) : item.situation === 1 ? (
                  <Situ text="Disponible" color="bg-green" />
                ) : (
              ...
              <div className="mt-2 px-4">
                <p className="flex items-center gap-1 font-medium lg:text-xl text-secondary">
                  <FaLocationDot className="text-primary lg:text-3xl" />{" "}
                  {item.address}
                </p>
                <div className="w-[100px]">
                  <h2 className="font-bold text-2xl mt-2 lg:text-2xl">
                    {item.title}
                  </h2>
                </div>
