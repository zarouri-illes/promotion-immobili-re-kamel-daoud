...
const profile = {
  ...
  description:
    "La Promotion Immobilière Daoud Kamel se lance dans le système management qualité, Autrement la structuration de l'entreprise selon les normes ISO 9001 avec enthesiuasme. À la recherche de l'excellence, L'agence vise à perfectionner sa gestion de la qualité, intégrant les principes et pratiques du Management de la qualité pour garantir une conformité optimale et renforcer sa réputation dans le secteur immobilier.",
  image: {
    link: "/logo.png",
