...
const page = () => {
  const slides = ["/riche1/pic1.jpg", "/riche1/pic2.jpg", "/riche1/pic3.jpg"];

  const details = {
    title: "Résidence Erriche 1",
    description:
      "Bienvenue à La résidence 26 Logements, une résidence de premier choix située au cœur d'Erriche, Bouira. Cette propriété exceptionnelle offre une expérience de vie inégalée, alliant commodités modernes et beauté sereine de son environnement. Chaque appartement de la résidence est conçu avec confort et élégance, offrant des espaces de vie spacieux, des installations à la pointe de la technologie et des vues imprenables. Que vous recherchiez un refuge paisible ou un style de vie communautaire dynamique, Cette résidence promet d'être la maison idéale pour vous et votre famille. Découvrez le luxe et la commodité de vivre dans l'un des emplacements les plus prisés de Bouira.",
    appa: [
      {
        name: "F3",
        price: "9.500.000 DA",
  ...
  return (
    <div>
      ...
      <section className="w-full mt-16 mb-32 px-8 md:px-16 xl:px-16">
        ...
        <div className=" md:w-[600px] w-full pt-11">
